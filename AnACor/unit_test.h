...
void test_ray_classes( Path2_c path_1,int64_t* coord,int * h_ray_classes,int diagonal){
        printf("CPU ==> coord is [%ld,%ld,%ld] \n",coord[0],coord[1],coord[2]);
        int64_t *path_ray_classes = path_1.ray_classes;
        int64_t len_path_2 = path_1.len_path_2;
        int64_t len_classes = path_1.len_classes;
