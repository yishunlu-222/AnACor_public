...
def worker_function(t1,low, up,dataset,selected_data ,label_list,
    ...
    t2 = time.time()
    time_list.append(['loading time is',t2-t1])
    if args.gpu:
        ...
        time_list.append(['GPU time is',t3-t2])
        print('GPU time is {}'.format(t3-t2))
        # pdb.set_trace()
    else:
